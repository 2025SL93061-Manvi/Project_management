...
(3, 'Data Migration',        'Migrate legacy data to new cloud database',     'ACTIVE',    '2024-02-01', '2024-05-31', 3, NOW()),
(4, 'HR Portal',             'Internal HR self-service portal',               'COMPLETED', '2023-06-01', '2023-12-31', 3, NOW()),
...
(3,  'Republic Day',            '2024-01-26'),
(4,  'Presidents'' Day',        '2024-02-19'),
(5,  'Holi',                    '2024-03-25'),
(6,  'Good Friday',             '2024-03-29'),
(7,  'Eid al-Fitr',             '2024-04-10'),
(8,  'Memorial Day',            '2024-05-27'),
(9,  'Buddha Purnima',          '2024-05-23'),
(10, 'Eid al-Adha',             '2024-06-17'),
(11, 'Independence Day (US)',   '2024-07-04'),
(12, 'Independence Day (India)','2024-08-15'),
(13, 'Ganesh Chaturthi',        '2024-09-07'),
(14, 'Labor Day',               '2024-09-02'),
(15, 'Gandhi Jayanti',          '2024-10-02'),
(16, 'Dussehra',                '2024-10-12'),
(17, 'Halloween',               '2024-10-31'),
(18, 'Diwali',                  '2024-11-01'),
(19, 'Guru Nanak Jayanti',      '2024-11-15'),
(20, 'Thanksgiving Day',        '2024-11-28'),
(21, 'Day After Thanksgiving',  '2024-11-29'),
(22, 'Christmas Eve',           '2024-12-24'),
(23, 'Christmas Day',           '2024-12-25'),
(24, 'New Year''s Eve',         '2024-12-31'),

-- 2025
(25, 'New Year''s Day',         '2025-01-01'),
(26, 'Republic Day',            '2025-01-26'),
(27, 'Holi',                    '2025-03-14'),
(28, 'Eid al-Fitr',             '2025-03-30'),
(29, 'Good Friday',             '2025-04-18'),
(30, 'Buddha Purnima',          '2025-05-12'),
(31, 'Eid al-Adha',             '2025-06-07'),
(32, 'Independence Day (US)',   '2025-07-04'),
(33, 'Independence Day (India)','2025-08-15'),
(34, 'Ganesh Chaturthi',        '2025-08-27'),
(35, 'Gandhi Jayanti',          '2025-10-02'),
(36, 'Dussehra',                '2025-10-02'),
(37, 'Halloween',               '2025-10-31'),
(38, 'Diwali',                  '2025-10-20'),
(39, 'Guru Nanak Jayanti',      '2025-11-05'),
(40, 'Thanksgiving Day',        '2025-11-27'),
(41, 'Christmas Eve',           '2025-12-24'),
(42, 'Christmas Day',           '2025-12-25'),
(43, 'New Year''s Eve',         '2025-12-31'),

-- 2026
(44, 'New Year''s Day',         '2026-01-01'),
(45, 'Republic Day',            '2026-01-26'),
(46, 'Holi',                    '2026-03-03'),
(47, 'Eid al-Fitr',             '2026-03-20'),
(48, 'Good Friday',             '2026-04-03'),
(49, 'Eid al-Adha',             '2026-05-27'),
(50, 'Buddha Purnima',          '2026-05-31'),
(51, 'Independence Day (US)',   '2026-07-04'),
(52, 'Independence Day (India)','2026-08-15'),
(53, 'Ganesh Chaturthi',        '2026-09-16'),
(54, 'Gandhi Jayanti',          '2026-10-02'),
(55, 'Dussehra',                '2026-10-21'),
(56, 'Halloween',               '2026-10-31'),
(57, 'Diwali',                  '2026-11-08'),
(58, 'Guru Nanak Jayanti',      '2026-11-24'),
(59, 'Thanksgiving Day',        '2026-11-26'),
(60, 'Christmas Eve',           '2026-12-24'),
(61, 'Christmas Day',           '2026-12-25'),
(62, 'New Year''s Eve',         '2026-12-31');
